...
# LoRA for battlemap generation
_LORA_TRIGGER = "<lora:DD_Table_RPG:0.85>"

_BASE_STYLE = f"""{_LORA_TRIGGER} tabletop RPG battlemap, top-down view, dungeon tile,
floor plan perspective, bird's eye view, looking straight down,
D&D map, fantasy cartography, hand-drawn map style,
dungeon floor texture, torch-lit atmosphere, parchment edges"""

_NEGATIVE = """3d render, perspective view, side view, isometric, character, people,
monsters, miniatures, tokens, grid lines, numbers, text, watermark, signature,
...
walls from side, standing figures, portrait, face, anime, cartoon"""

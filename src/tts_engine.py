...
VOICE_MAP: dict[str, str] = {
    ...
    "gossip":       "en-US-SaraNeural",     # Warm, conspiratorial
    "rumour":       "en-US-SaraNeural",     # Same energy as gossip
    "sports":       "en-US-JasonNeural",    # Energetic, arena hype
    "arena":        "en-US-JasonNeural",    # Same — arena events
    "weather":      "en-US-JennyNeural",    # Measured, matter-of-fact
    "rift":         "en-US-DavisNeural",    # Deep, ominous
    "missing":      "en-US-SaraNeural",     # Urgent, concerned
    "bounty":       "en-US-TonyNeural",     # Gruff, bounty-board gravitas
    "crime":        "en-US-TonyNeural",     # Same gravitas for crime/incident
    ...
    "human_interest":"en-US-NancyNeural",   # Warm, personal storytelling
    "divine":       "en-US-DavisNeural",    # Deep, reverent
...
_KEYWORD_VOICE_RULES: list[tuple[list[str], str]] = [
    ...
    (["arena", "duel", "argent blades", "combat sport",
      "tournament", "championship"],                          "en-US-JasonNeural"),
    # Rift / divine / ominous
    (["rift", "divine", "serpent choir", "religious", "god ",
      "void", "eldritch", "planar", "collapse"],              "en-US-DavisNeural"),
    # Missing persons / urgent
    (["missing person", "missing persons", "last seen",
      "whereabouts unknown"],                                  "en-US-SaraNeural"),
    # Bounty / crime / wanted
    (["bounty", "wanted", "crime", "incident", "theft",
      "murder", "assault", "heist", "fugitive", "warrant"],   "en-US-TonyNeural"),
    # Gossip / rumour / whisper
    (["gossip", "rumour", "rumor", "whisper", "overheard",
      "word on the street", "scuttlebutt"],                    "en-US-SaraNeural"),
    ...
    (["human interest", "resident", "heartwarming", "community",
      ...
      "inquest", "survivor"],                                  "en-US-NancyNeural"),
]

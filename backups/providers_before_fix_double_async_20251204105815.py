...
class BaseProvider(ABC):
    ...
    @abstractmethod
    async async def chat_completion(self, messages: List[Dict[str, str]], model: str, **kwargs) -> str:
...
class FreeProvider:
    ...
    def __init__(self):
        ...
        # Name used internally by the bot; mostly cosmetic for Free
        self.default_model_name = "gpt-free"

    async def acreate(self, messages, model_name=None, **kwargs):
        """
        Async-style entrypoint for compatibility with the rest of the bot.
        """
        import g4f
        ...
        # g4f provides a synchronous API; just call it directly
    ...
    async def chat_completion(self, messages, model_name=None, **kwargs):
        """
        Synchronous-style completion used by some call paths in the bot.
        """
        import g4f

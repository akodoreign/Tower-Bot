...
class FreeProvider:
    ...
    def __init__(self):
        ...
        # Inject Tower-of-Last-Chance lore context
        try:
            from . import tower_rag
            lore_context = tower_rag.build_context_from_messages(messages)
            if lore_context:
                messages = [{"role": "system", "content": lore_context}] + messages
        except Exception:
            pass
        ...
        return contentasync def acreate(self, messages, model_name=None, **kwargs):
